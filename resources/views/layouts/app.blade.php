      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="h2 mb-0">Binary<span class="text-primary">.</span> </a></h1>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  <a href="#contact-section" class="nav-link">More</a>
                  ...
                  @else
                    <ul class="dropdown">
                      <li><a href="{{route('home.login')}}" class="nav-link">Login</a></li>
                    </ul>
                  @endif
                </li>
              </ul>
